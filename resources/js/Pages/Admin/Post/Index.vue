        ...
        <div class="py-12">
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mb-5">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="flex bg-gray-800 justify-between items=center p5">
                    ...
                    <table class="w-full text-sm text-left text-gray-500">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                            <tr>
                                ...
                                <th scope="col" class="py-3 px-6" v-if="can.edit || can.delete">Actions</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr v-for="post in posts.data" :key="post.id" class="bg-white border-b darK:border-gray-700">
                                <td data-label="Title" class="py-4 px-6">{{ post.title }}</td>
                                <td data-label="Description" class="py-4 px-6">{{ post.description }}</td>
                                <td v-if="can.edit || can.delete" class="py-4 px-6 w-48">
                                    <div type="justify-start lg:justify-end" no-wrap>
                                        ...
                                        <BreezeButton class="ml-4 bg-red-500 px-2 py-1 rounded text-white cursor-pointer" v-if="can.edit">
                                            Delete
                                        </BreezeButton>
                                    </div>
                                </td>
