            ...
            <div class="max-w--7xl mx-auto sm:px-6 lg:px-8 mb-2">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <table class="w-full text-sm text-left text-gray-500">
                        ...
                        <tbody>
                            <tr v-for="permission in permissions.data" :key="permission.id" class="bg-white border-b darK:border-gray-700">
                                <td data-label="Name" class="py-4 px-6">{{ permission.name }}</td>  
